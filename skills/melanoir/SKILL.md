---
name: melanoir
description: 멜라누아 IG 카드뉴스(캐러셀) 콘텐츠 엔진. 토픽 → 골드 스탠다드 캐러셀(카피=melanoir-copywriter 에이전트·구독 LLM, 렌더=node-canvas 골드 대조, 브랜드·광고법 가드) → Supabase 콘솔 검토·피드백 → 실시간 학습 루프. "멜라누아 카드/캐러셀 만들어", "오늘 콘텐츠", "인스타 카드뉴스 발행", "반영구 색소 콘텐츠" 같은 요청에서 사용.
---
